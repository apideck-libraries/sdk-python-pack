...
```bash
pip install git+https://github.com/apideck-libraries/sdk-python-pack.git#subdirectory=accounting
```
...
```bash
poetry add git+https://github.com/apideck-libraries/sdk-python-pack.git#subdirectory=accounting
```
