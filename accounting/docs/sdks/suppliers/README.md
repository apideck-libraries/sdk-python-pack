...
with SDK(
    ...
    res = sdk.accounting.suppliers.get(id="<id>", consumer_id="test-consumer", app_id="dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX", service_id="salesforce", fields="id,updated_at")
...
**[models.AccountingSuppliersOneResponse](../../models/accountingsuppliersoneresponse.md)**
...
with SDK(
    ...
    res = sdk.accounting.suppliers.update(id="<id>", consumer_id="test-consumer", app_id="dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX", service_id="salesforce", display_id="EMP00101", display_name="Windsurf Shop", company_name="SpaceX", company_id="12345", title="CEO", first_name="Elon", middle_name="D.", last_name="Musk", suffix="Jr.", individual=True, addresses=[
    ...
    ], phone_numbers=[
        {
            ...
            "area_code": "323",
            "extension": "105",
            "type": openapi.PhoneNumberType.PRIMARY,
        },
        {
            "number": "111-111-1111",
            "id": "12345",
    ...
    ], emails=[
        {
            "email": "elon@musk.com",
            "id": "123",
            "type": openapi.EmailType.PRIMARY,
        },
        {
            "email": "elon@musk.com",
            "id": "123",
    ...
    ], websites=[
        {
            ...
            "id": "12345",
            "type": openapi.WebsiteType.PRIMARY,
        },
        {
            "url": "http://example.com",
            "id": "12345",
        ...
        "id": "123456",
        "rate": 10,
    }, tax_number="US123945459", currency=openapi.Currency.USD, account={
        "id": "123456",
        "nominal_code": "N091",
        "code": "453",
    }, status=openapi.SupplierStatus.ACTIVE, payment_method="cash", channel="email", custom_fields=[
        {
            "id": "2389328923893298",
            "name": "employee_level",
...
with SDK(
    ...
    res = sdk.accounting.suppliers.delete(id="<id>", consumer_id="test-consumer", app_id="dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX", service_id="salesforce")
