...
AccountingExpensesOneResponseTypedDict = TypeAliasType(
    "AccountingExpensesOneResponseTypedDict",
    Union[UnexpectedErrorResponseTypedDict, GetExpenseResponseTypedDict],
)


AccountingExpensesOneResponse = TypeAliasType(
    "AccountingExpensesOneResponse", Union[UnexpectedErrorResponse, GetExpenseResponse]
)
