...
class AccountingSubsidiariesDeleteGlobals(BaseModel):
...
class AccountingSubsidiariesDeleteRequestTypedDict(TypedDict):
    id: str
...
class AccountingSubsidiariesDeleteRequest(BaseModel):
    id: Annotated[
...
AccountingSubsidiariesDeleteResponseTypedDict = TypeAliasType(
    ...
    Union[UnexpectedErrorResponseTypedDict, DeleteSubsidiaryResponseTypedDict],
)


AccountingSubsidiariesDeleteResponse = TypeAliasType(
    "AccountingSubsidiariesDeleteResponse",
    Union[UnexpectedErrorResponse, DeleteSubsidiaryResponse],
)
