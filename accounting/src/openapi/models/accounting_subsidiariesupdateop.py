...
AccountingSubsidiariesUpdateResponseTypedDict = TypeAliasType(
    "AccountingSubsidiariesUpdateResponseTypedDict",
    Union[UnexpectedErrorResponseTypedDict, UpdateSubsidiaryResponseTypedDict],
)


AccountingSubsidiariesUpdateResponse = TypeAliasType(
    "AccountingSubsidiariesUpdateResponse",
    Union[UnexpectedErrorResponse, UpdateSubsidiaryResponse],
)
