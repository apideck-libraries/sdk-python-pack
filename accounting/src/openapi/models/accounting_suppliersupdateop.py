...
AccountingSuppliersUpdateResponseTypedDict = TypeAliasType(
    "AccountingSuppliersUpdateResponseTypedDict",
    Union[UnexpectedErrorResponseTypedDict, UpdateSupplierResponseTypedDict],
)


AccountingSuppliersUpdateResponse = TypeAliasType(
    "AccountingSuppliersUpdateResponse",
    Union[UnexpectedErrorResponse, UpdateSupplierResponse],
)
